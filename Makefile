...
testnet-itw3: ## Start iTw3 Testnet
	./blockchain/bin/itw3d --confirm-external-bind --testnet --detach --testnet-rpc-bind-ip=0.0.0.0 --testnet-p2p-bind-ip=0.0.0.0 --data-dir=data/itw3/testnet --pidfile=data/itw3/itw3d-testnet.pid

testnet-lthn: ## Start Lethean Testnet
	./blockchain/bin/letheand --confirm-external-bind --testnet --detach --testnet-rpc-bind-ip=0.0.0.0 --testnet-p2p-bind-ip=0.0.0.0 --data-dir=data/lthn/testnet --pidfile=data/lthn/letheand-testnet.pid
